        ...
        <div class="-footer-wrap"
          ...
          <van-swipe-cell :right-width="65">
            <button open-type='share'
                    ...
                    class="-share-btn">
              <img class="-share-img"
                   src="https://pub.file.k12.vip/read/my/zp-button-share.png" />
            </button>
            <div class="-footer-item"
                 @click="lookOtherRead(item.id)">
              <div class="-item-tip"
                   v-if="index==0 && item.likes!=0">赞最多</div>
              <div class="-item-left">
                <div class="-item-title">
                  <span>《{{item.coursename}}》</span>
                  <img class="-img"
                       src="https://pub.file.k12.vip/read/my/msfd-button-play.png" />
                </div>
              </div>
              <div class="-item-down">
                ...
                <div class="-item-num">
                  <img class="-img"
                       src="https://pub.file.k12.vip/read/icon-good.png" />
            ...
            <div slot="right"
                 ...
                 class="-footer-action">
              <img class="-right-img"
                   src="https://pub.file.k12.vip/read/my/zp-icon-delete.png" />
            </div>
          </van-swipe-cell>
        </div>
      </div>
    ...
    <wux-popup :visible="isShowDel"
      ...
      <div class="ld-my-work-del">
        ...
        <div class="-del-footer">
          <div class="-btn"
               @click="openDel()">取消</div>
          <div class="-btn -two"
               @click="delItem()">确认</div>
        </div>
      </div>
    </wux-popup>
  </div>
